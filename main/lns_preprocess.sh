...
input_turbo_dir=`readlink -f $2`
turbo_scripts_folder=$input_turbo_dir/scripts
turbo_tmp_folder=$input_turbo_dir/scripts/tmp
...
${turbo_scripts_folder}/tokenizer.sed ${input_filename}.prep > ${turbo_tmp_folder}/tmp.tok1
...
cp ${turbo_tmp_folder}/tmp.conll.predpos.pred ${input_filename}.parsed
cd ${DIR}
